...
public class AdminUtilServiceImpl implements AdminUtilService{
	...
	@Override
	public String getWCSSPriceClassCd(OEResolvedUserSettingsSessionBean userSettings, AppSessionBean asb) throws AtWinXSException {
		return AdminUtil.getWCSSPriceClassCd(userSettings, asb);
	}
